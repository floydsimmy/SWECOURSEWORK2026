...
| R3  | Scope creep (save/load, networked play, animations)        | 3 | 2 | 6     | PO owns backlog; explicitly out-of-scope items refused at planning. Grid + dice and AI were *kept* in MVP scope at Sprint 2 midpoint (see ADR-006), not treated as scope creep — the team committed and delivered. | Held; no out-of-scope items shipped |
...
| R6  | Tests rot as engine evolves                                 | 1 | 2 | 2     | `pytest -q` gates every merge to main                                        | Held; 116 tests green at submission |
...
- **R3 (scope creep)** did not fire as a scope-creep risk. The Sprint 2 midpoint debate over grid + dice and AI was a deliberate scope *decision* — recorded in ADR-006 — not creep. The team committed to keep both in scope and absorb the cost (Sprint 2 extension, AI deferred to Sprint 3). No out-of-scope items (save/load, networked play, animations) made it into the codebase.
